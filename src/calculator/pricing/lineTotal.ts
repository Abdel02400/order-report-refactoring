...
import { FULL_PRICE_FACTOR, MORNING_BONUS_HOUR, MORNING_BONUS_RATE, NO_MORNING_BONUS } from '@/constants/promotions';
...
export function computeLineTotal(order: Order, product: Product | undefined, promo: ResolvedPromotion): LineTotalResult {
