...
import { CUSTOMER_LEVEL, CUSTOMER_LEVELS, toCustomerId, type Customer, type CustomerId } from '@/types/customer';
import { CURRENCY, type Currency } from '@/types/currency';
...
export const parseCustomers = (): Record<CustomerId, Customer> => {
    ...
    for (const row of rows) {
        ...
        const currency = (row.currency || CURRENCY.EUR) as Currency;
